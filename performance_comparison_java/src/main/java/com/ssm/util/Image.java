...
public class Image extends HttpServlet {
	...
	private static final long serialVersionUID = 5389375445556298461L;
    ...
    //纯数字
    private static final String baseNum = "0123456789";
    //纯字母
    private static final String baseLetter = "ABCDEFGHJKLMNOPQRSTUVWXYZ";
    //生成的图片的宽度
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        session.setAttribute("RWEERSFDSDFSDFSD", random);
