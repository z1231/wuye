<template>
  <div class='setting-modal'>
    <div class='modal-content'>
      <div class='modal-header'>新增库存</div>
      <div class="modal-form">
        <div class="modal-upload">
          <el-form ref="form" :model="form" label-width="80px">
            <el-form-item label="名称">
              <el-select style="width: 100%" v-model="form.title" class='condition-item' placeholder="请选择">
                <el-option
...
<script>
  export default {
    ...
    methods: {
      onSubmit(){
        this.$http.post('/serve/reperAdd', this.form)
          .then((res) => {
